...
namespace Tests
{
    public class AuthServiceTest
    {
        ...
        public void Setup()
        {
            ...
            _playerService.Setup(x => x.GetAsync("username", "encrypedPass")).ReturnsAsync(new Player()
            {
                Id = userId,
                Score = 100,
            ...
            _playerService.Setup(x => x.AddAsync(It.IsAny<Player>())).ReturnsAsync(new Player()
            {
                Id = userId,
                Password = "encrypedPass",
                UserName = "username"
            ...
            _authService = new AuthService(_playerService.Object, _jwtSetting, _encryptService.Object);
        }
